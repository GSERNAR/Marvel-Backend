...
const SheetScheme = new mongoose.Schema(
  {
    ...
    // Armored heroes (Iron Man, War Machine): per-form saved armor HP/PP, the pilot's own
    // HP/PP while suited up, and armor forms destroyed by lethal damage (locked out until repaired)
    ...
    rhodesCurrentHp: { type: Number, default: null },
    rhodesCurrentPp: { type: Number, default: null },
